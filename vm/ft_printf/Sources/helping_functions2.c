...
/*   Updated: 2019/07/06 21:40:17 by hmney            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		length_float(t_printf *store, t_float *float_data, int length_data)
{
	int length_final;
...
char	*calcul_fd_specialcase(t_printf store, t_float float_data)
{
	char *result;
