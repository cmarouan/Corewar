...
void				ft_errors_management(t_list *files, t_file *file, char *str,
		int index);
...
int					get_label(t_file *file, t_token *token, char *str,
		int *index);
...
int					get_args(t_file *file, t_token *token, char *str,
		int *index);
...
int					type_direct(t_file *file, t_token *token, char *arg,
		int num_arg);
int					type_indirect(t_file *file, t_token *token, char *arg,
		int num_arg);
int					check_args(t_file *file, t_token *token, char *arg,
		int num_arg);
