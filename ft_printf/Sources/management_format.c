...
/*   Updated: 2019/07/06 12:07:12 by hmney            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

static int	store_fieldwidth(t_printf *store, char *format, va_list ap)
{
	int index;
	int counter;
...
static int	store_precision(t_printf *store, char *format, va_list ap)
{
	int index;
	int counter;
...
static int	store_flags(t_printf *store, char *format)
{
	int index;
...
static int	store_lengthmodifier(t_printf *store, char *format)
{
	int counter;
...
int			management_format(t_printf *store, char *format, va_list ap)
{
	int jumper;
